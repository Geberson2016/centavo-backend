...
public class CentavoApplication {
    ...
    @Bean
    CommandLineRunner testDatabase(UserDAO userDAO, AccountDAO accountDAO, CategoryDAO categoryDAO) {
        return args -> {
            ...
            Category catGeber = new Category(null, gebersonId, "Financiamento Caixa", TransactionType.RECEITA, BudgetType.VARIAVEL);
